...
#         print(f"Final Cost ={self.cost}")
    ...
    def schedule(self):
        ...
        self.clock = tic_svc(cur_time=self.task_list[0]['start_time'],delta=1) # create universal clock
        self.clock_train = tic_svc(cur_time=self.task_list[0]['start_time'], delta=1) # create universal clock
